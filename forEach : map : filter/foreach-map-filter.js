...
function showFirstAndLast(arr){
    ...
    arr.forEach(function (words) {
        ...
        showFirstAndLast = words.charAt(0) + words.charAt(lastIndex);
        newArray.push(showFirstAndLast);
    })
    return newArray;
}
...
/*
Write a function called findInObj which accepts an array of objects, a key, and some value to search for and returns 
...
function findInObj(arr, key, searchValue) {
    // for (let i = 0; i < arr.length; i++) {
    //     if (arr[i].hasOwnProperty(key) && arr[i][key] === searchValue) {
    //             return arr[i];
    //     }
    //  }
